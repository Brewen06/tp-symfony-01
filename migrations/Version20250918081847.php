 ...
 */
final class Version20250918081847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318CF1849495 FOREIGN KEY (players_id) REFERENCES tbl_players (id)');
